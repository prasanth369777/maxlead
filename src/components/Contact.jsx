            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 bg-blue border border-gray-300 rounded-xl focus:border-orange-500 text-black" 
                >
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">maxleadadvertising@gmail.com</p>
                  </div>
                </div>
