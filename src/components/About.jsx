...
export default function About() {
  ...
  return (
    ...
    >
      {/* Background blobs */}
      <div
        className="absolute w-72 h-72 bg-orange-200/30 rounded-full blur-3xl pointer-events-none"
        style={{
          transform: `translate(${cursorPos.x * 0.02}px, ${cursorPos.y * 0.02}px)`,
        }}
      />
      <div
        className="absolute w-64 h-64 bg-orange-300/30 rounded-full blur-3xl pointer-events-none"
        style={{
          transform: `translate(${cursorPos.x * -0.02}px, ${cursorPos.y * -0.02}px)`,
        }}
      />
      ...
      <div className="relative z-10 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-24">
          <div className="inline-block px-4 py-2 bg-orange-50 rounded-full border border-orange-200 mb-6">
            <span className="text-orange-500 font-semibold">Why MaxLead</span>
          </div>
        ...
        {/* CTA */}
        <div className="bg-gradient-to-r from-white to-gray-300 rounded-3xl p-14 border border-orange-300 text-center">
          ...
          <button
            ...
            className="px-10 py-5 bg-gradient-to-r from-orange-400 to-orange-500 text-white rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-orange-400/50"
          >
